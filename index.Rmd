...
```{r readData}
# Read spatial data 
qp <- rgdal::readOGR(dsn='/Volumes/GoogleDrive/My Drive/_phd/_geoinfo/dist_SN/',
...
transectos_raw <- rgdal::readOGR(dsn='/Volumes/GoogleDrive/My Drive/_phd/_geoinfo/migrame/',
